    ...
    <div className="bg-[#f5f6fa] min-h-[calc(100vh-4rem)] p-6 rounded-2xl text-gray-800 font-sans -mt-6 mx-[-1.5rem] mb-[-1.5rem] overflow-hidden">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Read-only access to programme-wide data</p>
        </div>
        <div className="flex items-center space-x-3">
          <div className="flex items-center bg-amber-50 border border-amber-200 px-3 py-1.5 rounded-md">
            <Eye className="w-4 h-4 text-amber-600 mr-2" />
            <span className="text-sm font-medium text-amber-700">Read-Only</span>
          </div>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-amber-600">Read-Only View</span>
            </div>
          </div>
